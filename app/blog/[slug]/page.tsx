  ...
  return (
    <div className=" transition duration-400 ease-in-out bg-dark">
      <div className=" grid grid-cols-12">
        <div className="h-fit w-fit  pl-15 pt-15 col-start-1 ">
          <svg
        ...
        <div className="h-fill  col-start-10 card-head-side-l  col-span-3 ml-1 ">
          <ColorTester />
          <div className="flex items-end">
            <IoIosArrowRoundBack className=" text-5xl text-light" />
            <div className="by7 text-3xl ml-4 w-fill text-light ">
              Article Tree
            </div>
          </div>
        </div>
