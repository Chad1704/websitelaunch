    ...
    <div className="grid grid-cols-12 sticky top-0 z-50">
      <div className="col-start-10 card-head-side-l col-span-3 ml-1 transition duration-400 ease-in-out h-20">
        ...
        <div className="px-3 py-4">
          <Link href="/blog" className="big-button block">
            <div className="flex border rounded-2xl bg-dark  border-light cursor-pointer items-center px-2 py-1 transition hover:bg-light hover:text-dark text-light transition duration-400 ease-in-out ">
              <IoIosArrowRoundBack className="text-5xl  text-inherit" />
