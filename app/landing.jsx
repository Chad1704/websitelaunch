    ...
    <>
      <div className=" overflow-hidden ">
        <div className="grid grid-cols-10 grid-rows-10 h-screen bg-dark transition duration-400 ease-in-out ">
          ...
          <div className="relative hero-border transition duration-400 ease-in-out  flex col-span-9 lg:col-span-6 row-start-1 lg:row-start-1 row-span-5 lg:row-span-7  overflow-hidden">
          ...
          {/* About */}
          <div className=" flex about-border transition duration-400 ease-in-out  col-span-9 lg:col-span-2 row-span-2 lg:row-span-7">
          ...
          {/* Projects */}
          <div className="overflow-hidden pro-border flex items-center justify-center col-span-9 transition duration-400 ease-in-out lg:col-span-8 row-span-3 lg:row-span-4">
            <ProjectsHub />
          </div>
        </div>
      </div>
