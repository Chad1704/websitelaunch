export const metadata = {
  ...
  time: 20,
  excerpt:
    "After working on and off for about a year (feels like 3), I'm finally somewhat happy with this all-new redesign of chadkatz.com.",
  image: "alive-post/chadkatzsite.PNG",
};
...
This project was honestly a nightmare that I have finnaly awoken from. im not even fully satified with the end result but like number 7 says I need to be ok without perfection, there are still tons of stuff about the website im not happy with but overall I think this is something I can show and be proud of
